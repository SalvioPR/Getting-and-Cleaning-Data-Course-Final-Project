library(dplyr)
f(!file.exists("./getcleandata")){dir.create("./getcleandata")}
...
> y_test <- read.table("./getcleandata/UCI HAR Dataaset/test/y_test.txt")
...
> save.image("~/Desktop/run_analysis.RData")
> 